...
public class MainActivity extends AppCompatActivity {
    ...
    public void executaConsulta(View view) {
        ...
        new DataGet(txtNome,txtSobrenome,txtMensagem).execute(url);
    }
    ...
    public void executaPut(View view) {
        ...
        try {
            ...
            new DataPut(txtMensagem).execute(url, mensagemPut.toString());
        ...
        public void executaDelete(View view) {
            ...
            new DataDelete(txtMensagem).execute(url);
        }
}
